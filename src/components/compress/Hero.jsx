...
import merge from "../../assets/compressicon.svg";
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center w-full">
        <div className="flex w-full justify-center items-center ">
          <img src={merge} alt="" className="w-[30px] mr-2" />
          <h1 className="text-white text-[32px]">Compress PDF</h1>
        </div>
        <p className="text-[14px] mt-2 text-white">
          THE EASIEST WAY TO COMPRESS YOUR PDF FILES
        </p>
      </div>
    </section>
  );
