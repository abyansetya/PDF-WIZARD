    ...
    >
      ...
      <div className="flex flex-col items-center justify-center w-full">
        <div className="flex w-full justify-center items-center ">
          ...
          <h1 className="text-white text-[32px]">Sign PDF Successfully!</h1>
        </div>
        <p className="text-[14px] mt-2 text-white">
          CLICK ON BELOW BUTTON TO DOWNLOAD SIGNED PDF
        </p>
      </div>
    </section>
  );
...
export default function DownloadSign() {
  return (
    <>
      <Hero />
      <div className="p-[10em] w -full font-jakarta">
        <div className="flex justify-center items-center">
          ...
          <button className="w-[400px] h-[90px] border-2 bg-[#e76a6a] border-none rounded text-white">
            <p className="text-[20px]">Download Signed PDF</p>
          </button>
